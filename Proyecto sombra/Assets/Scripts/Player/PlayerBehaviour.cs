    ...
    void Update()
    {
        ...
        if (!attacking)           
        {
          ...
          //-----------------------------------------------------------------------
           ...
           // ----------------------    Cambiar modo    ----------------------
           // ----------------------------------------------------------------
           if (Input.GetKey(KeyCode.LeftShift) && playerMode == 2)
           {
               playerMode = 1;
           }
           else if (Input.GetKey(KeyCode.LeftShift) && playerMode == 1)
           {
               playerMode = 2;
           }
            // --------------------------------------------------------
            ...
            offsetX = playerX - cam.transform.position.x;
            offsetY = playerY - cam.transform.position.y;
            distX = (transform.position.x - offsetX) - mouseX;
            distY = (transform.position.y - offsetY) - mouseY;
